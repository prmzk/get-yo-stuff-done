...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ["skull.svg", "skull.png", "get-yo-stuff-done.webp"],
      manifest: {
        name: "Get Yo Stuff Done Todo App",
        short_name: "GYSD",
        description:
          "Get Yo Stuff Done, a simple todo app. No server, no API. Import and export yo todo by your self.",
        theme_color: "#22C55E",
